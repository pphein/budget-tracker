...
//         handleTabChange(tabs[currentIndex + 1]); // swipe left -> next tab
//       } else if (deltaX > 0 && currentIndex > 0) {
//         handleTabChange(tabs[currentIndex - 1]); // swipe right -> previous tab
//       }
//     }
...
//               <label className="block">Amount:</label>
//               <input
//                 type="number"    // 👈 force number keyboard on mobile/tablet
//                 inputMode="decimal"
//                 value={amount}
...
//   const tabs = ['income', 'expense', 'balance'];
//   const touchStartX = useRef(null);
//   const isScrolling = useRef(false); // 👈 NEW: flag to detect scrollable element touches

//   // swipe handler
//   const handleTouchStart = (e) => {
//     // 👇 Check if the touch started inside a scrollable container (like a table with overflow-x-auto)
//     const target = e.target.closest('.overflow-x-auto');
//     if (target) {
//       isScrolling.current = true; // mark as scrolling → prevent swipe
//       return;
//     }
...
//       return; // 👈 prevent tab switching when user scrolls table horizontally
//     }
...
//               <label className="block">Amount:</label>
//               <input
//                 type="number"      // 👈 ensures number keypad on mobile
//                 inputMode="decimal" // 👈 improves UX on tablets/mobiles
//                 value={amount}
//                 onChange={(e) => setAmount(e.target.value)}
//                 className="w-full md:w-32 p-2 border rounded"
//               />
